							...
							[
								{
									...
									key: "vr-default",
									route:
										"/dashboards/virtual-reality/default",
									component:
										(
											<VRDefault />
										),
								},
								{
									...
									key: "vr-info",
									route:
										"/dashboards/virtual-reality/info",
									component:
										(
											<VRInfo />
										),
						...
						collapse:
							[
								...
								},
								{
									...
									key: "illustration",
									route:
										"/authentication/reset-password/illustration",
									component:
										(
											<ResetIllustration />
										),
						...
						collapse:
							[
								...
								},
								{
									...
									key: "illustration",
									route:
										"/authentication/lock/illustration",
									component:
										(
											<LockIllustration />
										),
							...
							[
								{
									...
									key: "basic",
									route:
										"/authentication/verification/basic",
									component:
										(
											<VerificationBasic />
										),
								...
								},
								{
									...
									key: "illustration",
									route:
										"/authentication/verification/illustration",
									component:
										(
